...
By experiment 36 — the last kept improvement, GPU right-sizing to 20 L40S — the gains had flattened. The remaining ~10 runs were scale-validation and a handful of crashes. 47 experiments in, the pipeline ran 10M rows reliably, on half the GPUs, in under three days.
