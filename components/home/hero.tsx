    ...
    <section className="mb-16 grid items-center gap-12 lg:grid-cols-[1.4fr_1fr]">
      <div>
        ...
        <h1 className="m-0 font-heading text-6xl font-semibold leading-[1.02] tracking-tight text-foreground lg:text-[80px]">
          Hello, I&rsquo;m{' '}
          <span className="font-display text-accent leading-[0.9] tracking-tighter">Nehil</span>.
        </h1>
        ...
        <div className="mt-7 flex gap-3">
          <Link href="/writing" className="no-underline">
            <SolidBtn>Read the writing <Icon.ArrowRight size={16} /></SolidBtn>
          </Link>
      ...
      <div className="relative grid place-items-center">
        ...
        <DoodleArrow
          ...
          width={90}
          height={50}
          style={{ position: 'absolute', top: -10, right: -10, transform: 'rotate(15deg)' }}
        />
      </div>
    </section>
  );
