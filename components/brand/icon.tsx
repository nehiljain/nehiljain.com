...
export const Icon = {
  Home: (p: IconProps) => (
    <NJIcon {...p}>
      <path data-duo="fill" d="M4 11l8-6 8 6v8a1 1 0 0 1-1 1h-4v-6h-6v6H5a1 1 0 0 1-1-1z" />
  ...
  Twitter: (p: IconProps) => (
    <NJIcon {...p}>
      <path data-duo="fill" d="M4 4l7 9-7 7h3l5.5-5.5L17 20h3l-7.5-9.5L19.5 4h-3l-5 5L8 4z" />
  ...
  Spark: (p: IconProps) => (
    <NJIcon {...p}>
      <path data-duo="fill" d="M12 3l1.8 6.2L20 11l-6.2 1.8L12 19l-1.8-6.2L4 11l6.2-1.8z" />
